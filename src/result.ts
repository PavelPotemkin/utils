...
export const isOk = <T, E extends Error = Error>(result: Result<T, E>): result is Ok<T> =>
  result.ok;
export const isErr = <T, E extends Error = Error>(result: Result<T, E>): result is Err<E> =>
  !result.ok;
